...
public class PermissionCache {
    ...
    @Cacheable(value = "permission_cache", key = "T(cn.cordys.context.TenantContext).getTenantId() + ':' + #userId + ':' + #orgId")
    ...
    @CacheEvict(value = "permission_cache", key = "T(cn.cordys.context.TenantContext).getTenantId() + ':' + #userId + ':' + #orgId", beforeInvocation = true)
