...
public class CustomerCapacityController {
    ...
    public List<UserCapacityResponse> batchUserCapacity(@RequestParam(value = "poolId", required = false) String poolId) {
        return customerCapacityService.batchUserCapacity(poolId);
    }
}
