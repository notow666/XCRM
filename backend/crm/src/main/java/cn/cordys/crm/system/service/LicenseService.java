...
public class LicenseService {
    ...
    @Cacheable(value = "license_cache", key = "T(cn.cordys.context.TenantContext).getTenantId() + ':CORDYS-LICENSE'", unless = "#result == null")
    ...
    @CachePut(value = "license_cache", key = "T(cn.cordys.context.TenantContext).getTenantId() + ':CORDYS-LICENSE'", unless = "#result == null")
