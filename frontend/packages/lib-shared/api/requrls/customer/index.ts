...
export const BatchDeleteCustomerByConditionUrl = '/account/batch/delete-by-condition'; // 按筛选条件批量删除客户
...
export const ConvertCustomerCreateSourceToPrivateUrl = '/account/create-source/convert-to-private'; // 将本人公海组客户来源转为私海组
...
export const BatchTransferOpenSeaCustomerByConditionUrl = '/pool/account/batch-transfer-by-condition'; // 按筛选条件批量转移公海客户
export const BatchUpdateOpenSeaCustomerByConditionUrl = '/pool/account/batch-update-by-condition'; // 按筛选条件批量编辑公海客户
...
export const GetAccountCallRecordListUrl = '/account/call-record/page'; // 客户详情-通话记录列表
export const PreviewAccountCallRecordAudioUrl = '/account/call-record/audio'; // 客户详情-通话录音预览
...
export const GetCustomerAutoDeleteUrl = '/customer/autoDelete/get';
export const SaveCustomerAutoDeleteUrl = '/customer/autoDelete/save';
export const DeleteCustomerAutoDeleteUrl = '/customer/autoDelete/delete';
export const GetCustomerPrivateAutoDeleteUrl = '/customer/autoDelete/private/get';
export const SaveCustomerPrivateAutoDeleteUrl = '/customer/autoDelete/private/save';
export const DeleteCustomerPrivateAutoDeleteUrl = '/customer/autoDelete/private/delete';
