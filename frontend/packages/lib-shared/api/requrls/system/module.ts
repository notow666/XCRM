...
export const BatchUserCapacityUrl = '/account-capacity/batch-user-capacity'; // 批量获取用户库容信息

// 模块-公海池
export const GetCustomerPoolPageUrl = '/account-pool/page'; // 分页获取公海池
export const GetCustomerPoolListUrl = '/account-pool/list'; // 获取开启状态公海池列表
...
export const GetFieldCurrentDeptUserTreeUrl = '/field/user/current-dept/tree'; // 获取当前部门及下级成员树
