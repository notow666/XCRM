...
<script setup lang="ts">
  ...
  import { CustomerTableParams } from '@lib/shared/models/customer';
  ...
  import { batchUpdateCustomerByCondition } from '@/api/modules';
  ...
  function handleSave() {
    formRef.value?.validate(async (errors) => {
      ...
      try {
        ...
        const data = await batchUpdateCustomerByCondition({
          ...props.queryParams,
          updateCount: count,
