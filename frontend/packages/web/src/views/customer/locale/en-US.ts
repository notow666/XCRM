export default {
  ...
  'customer.toPoolCount': 'Move count',
  'customer.toPoolCountHint': 'Move the first N rows in list order, up to {limit} per batch',
  'customer.toPoolCountInvalid': 'Enter a number between 1 and {max}',
  'customer.batchTransferTaskSubmitted': 'Batch transfer task submitted',
  'customer.batchToPoolTaskSubmitted': 'Batch move-to-pool task submitted',
  'customer.batchDeleteTaskSubmitted': 'Batch delete task submitted',
  'customer.batchUpdateTaskSubmitted': 'Batch update task submitted',
  'customer.editByCondition': 'Edit by Filter',
  'customer.editByConditionTotal': '{total} account(s) in the current filter',
  'customer.editCount': 'Edit count',
  'customer.editCountHint': 'Edit the first N rows in list order, up to {limit} per batch',
  'customer.editCountInvalid': 'Enter a number between 1 and {max}',
  ...
  'customer.convertCreateSource': 'Convert filtered sources',
  'customer.convertCreateSourceConfirmTitle': 'Convert sources in the filtered results?',
  'customer.convertCreateSourceConfirmContent':
    'Within the current filtered results, your pool imports will become customer imports, and clue-created customers will become manually created customers.',
  'customer.convertCreateSourceEmptyTip': 'There are no filtered results to convert',
  'customer.convertCreateSourceSubmitted': 'Source conversion task submitted',
  'customer.createSource': 'Create source',
  'customer.createSourceManual': 'Manual create',
  'customer.createSourcePrivateImport': 'Customer import',
  'customer.createSourcePoolImport': 'Pool import',
  'customer.createSourceClue': 'Created from clue',
