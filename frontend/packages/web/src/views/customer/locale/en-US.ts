export default {
  ...
  'customer.assignSelectUsers': 'Select assignees',
  ...
  'customer.transferSelectPool': 'Select target open sea',
  'customer.transferSelectPoolPlaceholder': 'Please select target open sea',
