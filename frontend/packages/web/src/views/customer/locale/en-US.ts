export default {
  ...
  'customer.convertCreateSource': 'Convert source',
  'customer.convertCreateSourceConfirmTitle': 'Convert customer sources?',
  'customer.convertCreateSourceConfirmContent':
    'Pool imports will become customer imports, and clue-created customers will become manually created customers.',
