export default {
  ...
  'system.personal.dialSetting': 'Dial settings',
  'system.personal.dialSetting.defaultCard': 'Default calling card',
  'system.personal.dialSetting.description':
    'After setting, clicking the customer phone icon will call directly with the default card.',
  'system.personal.dialSetting.notSet': 'Not set, choose a card for each call',
  'system.personal.dialSetting.cardSlot1': 'Card slot 1',
  'system.personal.dialSetting.cardSlot2': 'Card slot 2',
  'system.personal.dialSetting.unavailable': 'Not configured',
  'system.personal.dialSetting.umMissing': 'UM is not configured for the current account.',
  'system.personal.dialSetting.deviceMissing': 'No MMBA device is configured for the current account.',
  'system.personal.dialSetting.saveSuccess': 'Default calling card saved',
  ...
  'system.personal.importing': 'Importing',
  'system.personal.cancelledExport': 'Cancelled export',
  'system.personal.cancelledImport': 'Cancelled import',
