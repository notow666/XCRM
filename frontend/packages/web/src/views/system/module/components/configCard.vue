<template>
  ...
  <CustomerConfigDrawer
    v-model:visible="customerFollowWayConfigVisible"
    :title="t('module.customerFollowWayConfig')"
    type="followWay"
  />
  <CustomerConfigDrawer
    v-model:visible="customerFailReasonConfigVisible"
  ...
  const staticConfigList = [
    ...
    },
    {
      ...
      groupList: [
        ...
        {
          label: t('module.customerFollowWayConfig'),
          key: 'customerFollowWayConfig',
        },
        {
          label: t('module.customerFailReasonConfig'),
  ...
  function handleSelect(key: string, item: ModuleConfigItem) {
    ...
    switch (item.key) {
      case ModuleConfigEnum.CUSTOMER_MANAGEMENT:
        ...
        } else if (key === 'customerFollowWayConfig') {
