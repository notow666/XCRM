export default {
  ...
  'module.customer.capacityOver': 'Insufficient capacity, {count} customers unassigned',
  'module.customer.assignRemain': '{count} customers remain unassigned',
  ...
  'module.clue.autoDistribute': 'Auto distribute',
  ...
  'module.clue.clueDistributeRule': 'Lead distribute rules',
  'module.clue.targetCustomerPool': 'Target open sea',
  ...
  'module.clue.updateConfirmContent': 'After updating, the new rules will only apply to newly created data.',
  ...
  'module.customerStepSetTitle': 'Customer Stage Settings',
  'module.customerStepSetSection': 'Stage configuration',
  'module.customerStepSetColumn': 'Stage Name',
  'module.customerStepSetRollback': 'Stage rollback settings',
  ...
  'module.customerFollowWayConfig': 'Follow-up method configuration',
  'module.customerFailReasonConfig': 'Customer fail reason configuration',
  ...
  'module.customerRepeatRule': 'Customer repeat rule',
  'module.customerRepeatRuleDays': 'Repeat days',
  'module.customerRepeatRulePlaceholder': 'Enter days',
  'module.customerRepeatRuleTip':
    'Only manually created customers use this rule. After the configured number of days, the same mobile can be created again.',
  'module.agent': 'Agent',
