export default {
  ...
  'module.customer.capacityOver': '负责人库容不足，剩余{count}个客户未分配',
  'module.customer.assignRemain': '剩余{count}个客户未分配',
  ...
  'module.clue.autoDistribute': '自动分发',
  ...
  'module.clue.clueDistributeRule': '线索分发规则',
  'module.clue.targetCustomerPool': '目标公海池',
  ...
  'module.clue.updateConfirmContent': '更新后，更新的规则仅对新产生的数据生效',
  ...
  'module.customerStepSetTitle': '客户阶段设置',
  'module.customerStepSetSection': '阶段配置',
  'module.customerStepSetColumn': '阶段名称',
  'module.customerStepSetRollback': '阶段回退设置',
  ...
  'module.customerFollowWayConfig': '跟进方式设置',
  ...
  'module.dataCleanupTip':
    '当数据的入库时间超过设置的清理天数后，勾选字段内容将会被自动清理，系统每日凌晨 1:00-2:00 执行，被清理的数据将不会被统计',
  'module.customerAutoDeleteDays': '删除天数',
  ...
  'module.customerRepeatRule': '客户重复规则',
  'module.customerRepeatRuleDays': '重复天数',
  'module.customerRepeatRulePlaceholder': '请输入天数',
  'module.customerRepeatRuleTip': '仅手动创建客户适用该规则，超过配置天数后允许再次创建同手机号客户',
  'module.agent': '智能体',
  'module.contract': '合同',
  'module.order': '订单',
  'module.task': '任务',
