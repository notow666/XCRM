export default {
  ...
  'org.userName': 'Name',
  'org.loginAccount': 'Login account',
  'org.loginAccountErrTip': 'Login account must be 6-64 characters and only supports letters and numbers',
  'org.gender': 'Gender',
  'org.userEmail': 'Email',
  ...
  'org.resetPassWordContent':
    'After reset, employees log in with the initial password (last 6 characters of login account)',
  ...
  'org.enabledUserTipContent': 'Enabled, employees can log in with the login account',
  ...
  'org.searchByNameAndPhone': 'Search by name/login account',
