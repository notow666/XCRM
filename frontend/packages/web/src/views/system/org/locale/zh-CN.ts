export default {
  ...
  'org.userName': '姓名',
  'org.loginAccount': '登录账号',
  'org.loginAccountErrTip': '登录账号长度为6-64位，仅支持字母和数字',
  'org.gender': '性别',
  'org.userEmail': '邮箱',
  'org.um': 'MMBA用户唯一标识',
  'org.department': '部门',
  ...
  'org.resetPassWordContent': '重置后，员工通过初始密码（登录账号后 6位）登录系统',
  ...
  'org.enabledUserTipContent': '启用后，员工可以通过登录账号登录系统',
  'org.formalUser': '正式',
  ...
  'org.searchByNameAndPhone': '通过姓名/登录账号搜索',
